    ...
    <div id="app">
        <div class="row mt-5">
            <div class="col-12 p-3">
                ...
                <div class="mt-3">
                    <span class="badge btn-primary">{{$article->state->likes}}<i class="far fa-thumbs-up"></i> </span>
                    <span class="badge btn-danger">{{$article->state->views}}<i class="far fa-eye"></i> </span>
                </div>
            </div>
        </div>
        <hr>
